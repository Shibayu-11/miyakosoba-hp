...
export const menu: MenuItem[] = [
  ...
  },
  {
    id: 'zaru-soba',
    type: 'soba',
    name: { ja: 'ざるそば', en: 'Zaru Soba', zh: '竹筛荞麦面', ko: '자루소바' },
    description: { ja: 'のどごしのよい冷たいそばを、香り豊かなつゆで。', en: 'Chilled soba noodles served with a fragrant dipping sauce.', zh: '爽滑冰凉的荞麦面，搭配香气浓郁的蘸汁。', ko: '목넘김 좋은 차가운 소바를 향긋한 장국과 함께.' },
    price: 490,
  ...
  },
  {
    id: 'zaru-udon',
    type: 'udon',
    name: { ja: 'ざるうどん', en: 'Zaru Udon', zh: '竹筛乌冬面', ko: '자루우동' },
    description: { ja: 'つるりとした冷たいうどんを、香り豊かなつゆで。', en: 'Chilled udon noodles served with a fragrant dipping sauce.', zh: '爽滑冰凉的乌冬面，搭配香气浓郁的蘸汁。', ko: '매끄러운 차가운 우동을 향긋한 장국과 함께.' },
    price: 490,
    image: '/images/menu-zaru-udon.png',
    allergens: ['小麦', '大豆'],
  },
  {
    id: 'kitsune',
  ...
  {
    id: 'ontama-kakiage-bukkake',
    type: 'udon',
    name: { ja: '温玉かき揚げぶっかけ', en: 'Soft Egg Kakiage Bukkake Udon', zh: '温泉蛋炸什锦天妇罗拌乌冬面', ko: '온천달걀 카키아게 붓카케우동' },
    description: { ja: '冷たいうどんに香ばしいかき揚げと温玉をのせた、満足の一杯。', en: 'Chilled udon topped with fragrant kakiage and a soft-cooked egg.', zh: '冰凉乌冬面配上香脆炸什锦天妇罗和温泉蛋，满足感十足。', ko: '차가운 우동에 고소한 카키아게와 온천달걀을 올린 든든한 한 그릇.' },
    price: 670,
    image: '/images/menu-ontama-kakiage-bukkake.png',
  ...
  },
  {
    id: 'shoga-ten',
    type: 'both',
    name: { ja: 'しょうが天そば／うどん', en: 'Ginger Tempura Soba/Udon', zh: '姜丝天妇罗荞麦面／乌冬面', ko: '생강튀김 소바／우동' },
