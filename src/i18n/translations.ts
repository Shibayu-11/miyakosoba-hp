...
export const translations: Record<Lang, Dict> = {
  ja: {
    ...
    contact: {
      ...
      phoneNumber: '06-6372-2061',
      phoneHoursLabel: '受付時間',
      phoneHours: '7:00〜22:00（土日祝日を含む）',
  ...
  en: {
    ...
    contact: {
      ...
      phoneHours: '7:00–22:00 (including weekends and holidays)',
  ...
  ko: {
    ...
    contact: {
      ...
      phoneHours: '7:00〜22:00（주말 및 공휴일 포함）',
